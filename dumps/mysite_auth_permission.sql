...
CREATE TABLE `auth_permission` (
  ...
  CONSTRAINT `auth_p_content_type_id_c6d8eb7a6e6641b_fk_django_content_type_id` FOREIGN KEY (`content_type_id`) REFERENCES `django_content_type` (`id`)
...
-- Dump completed on 2015-07-20 21:51:53
